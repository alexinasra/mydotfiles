...
mkdir -pv $SRC_DIR/oreo_custom_cursors

for file in $(ls $HOME/.cache/wal/oreo_custom_cursors_*); do
  cp -v $file $SRC_DIR/oreo_custom_cursors/${file#$HOME/.cache/wal/oreo_custom_cursors_}
